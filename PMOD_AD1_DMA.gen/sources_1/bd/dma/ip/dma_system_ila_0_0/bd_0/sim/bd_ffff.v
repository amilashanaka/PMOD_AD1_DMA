...
(* CORE_GENERATION_INFO = "bd_ffff,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ffff,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "dma_system_ila_0_0.hwdef" *) 
module bd_ffff
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tlast,
    SLOT_0_AXIS_tready,
  ...
  bd_ffff_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe4(net_slot_0_apc_pc_asserted));
  bd_ffff_slot_0_apcs_0 slot_0_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
