...
simulate()
{
  xsim dma -key {Behavioral:sim_1:Functional:dma} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ffff.protoinst" -protoinst "protoinst_files/dma.protoinst" -log simulate.log
}
