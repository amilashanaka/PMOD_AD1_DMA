...
HD_PWD='C:/Projects/ERN24004/Projects/PMOD_AD1_DMA/PMOD_AD1_DMA.runs/dma_PmodAD1_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_PmodAD1_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_PmodAD1_0_2.tcl
